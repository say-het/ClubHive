...
function Home() {
  ...
  // Function to remove a committee member
  ...
  // Function to update a committee member's details
        ...
        {isCreateGroupModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className={`bg-teal-600 p-6 rounded-lg shadow-xl w-3/5 max-w-lg transform transition duration-500 hover:scale-105 ${isDarkTheme ? 'bg-teal-800' : ''}`}>
              ...
              <div className="mb-4">
                <h4 className="text-white font-semibold">Add Committee Members</h4>
                {committeeMembers.map((member, index) => (
                  <div key={index} className="mb-2 flex space-x-2">
                    <input
                      ...
                      className="p-3 border border-teal-300 rounded-lg w-full bg-teal-700 text-white"
                    />
                    <input
                      type="text"
                      placeholder="Role"
